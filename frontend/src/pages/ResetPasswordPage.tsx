    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center p-4">
            <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
                <h1 className="text-2xl font-bold mb-2 text-gray-900 dark:text-white">Set New Password</h1>
                <p className="text-gray-600 dark:text-gray-400 mb-6">Choose a password for your account.</p>
                ...
                <div className="mt-4 text-center">
                    <a href="/forgotPassword" className="text-sm text-pink-600 dark:text-pink-400 hover:underline">
                        ← Request a new link
                    </a>
                </div>
            </div>
