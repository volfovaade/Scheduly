            ...
            <div className="max-w-4xl mx-auto p-6 lg:p-8">
                ...
                <div className="text-center mb-12">
                    <div className="inline-flex items-center justify-center mb-6">
                        <img src={Logo} alt="Scheduly logo" className="w-21 h-20 text-white" />
                    </div>
                    <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white mb-4">
                        Welcome in <span className="text-pink-700 dark:text-pink-400">Scheduly</span>
                    </h1>
                    <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                        Modern platform for event and reunion organization. Join the events by code received from your friend/colleague or create your own event.
                    </p>
                </div>
                {/* Join event card */}
                    ...
                    <div className="bg-gradient-to-br from-pink-700 to-pink-800 rounded-2xl p-8 text-white">
                        <div className="flex flex-col sm:flex-row items-center justify-between">
                            <div className="mb-6 sm:mb-0">
                                <h2 className="text-2xl font-bold mb-2">You already have account</h2>
