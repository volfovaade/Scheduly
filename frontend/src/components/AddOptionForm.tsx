              ...
              {event.timeRangeFrom && event.timeRangeTo && (
                <div className="mb-3 p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                  <p className="text-sm text-blue-800 dark:text-blue-300">
                    📅 Event time range:{" "}
                    {formatLocalDateTime(new Date(event.timeRangeFrom))} -{" "}
                    {formatLocalDateTime(new Date(event.timeRangeTo))}
                  </p>
                </div>
              )}
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    min={
                      event.timeRangeFrom
                        ? formatDateTime(new Date(event.timeRangeFrom))
                        : undefined
                    }
                    max={
                      event.timeRangeTo
                        ? formatDateTime(new Date(event.timeRangeTo))
                        : undefined
                    }
                  />
                </div>
              ...
              <div className="mt-6 p-4 bg-gradient-to-r from-pink-50 to-purple-50 dark:from-pink-900/20 dark:to-purple-900/20 border border-pink-200 dark:border-pink-800 rounded-lg">
                ...
                <div className="space-y-1 text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <p>
                    ...
                    {new Date(timeFrom).toLocaleString("en-US", {
                      dateStyle: "long",
                      timeStyle: "short",
                    })}{" "}
                    -{" "}
                    {new Date(timeTo).toLocaleString("en-US", {
                      timeStyle: "short",
                    })}
                  </p>
                </div>
