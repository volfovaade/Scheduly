  ...
  <div className="bg-white dark:bg-gray-900 border border-yellow-200 dark:border-gray-700 rounded-2xl p-8 shadow-xl">
    ...
    <div className="space-y-4">
      <div className="flex items-start gap-4 p-5 bg-gray-50 dark:bg-gray-800/80 rounded-xl border border-gray-100 dark:border-gray-700">
        ...
        <div>
          <p className="font-medium text-gray-500 dark:text-gray-400 text-sm uppercase tracking-wider mb-1">
            Location
          </p>
      ...
      <div className="flex items-start gap-4 p-5 bg-gray-50 dark:bg-gray-800/80 rounded-xl border border-gray-100 dark:border-gray-700">
        ...
        <div>
          ...
          <p className="text-xl font-bold text-gray-900 dark:text-white capitalize">
            From:{" "}
            {event.isMultiDay
              ? formatLocalDate(event.finalTimeFrom)
              : formatLocalDateTime(event.finalTimeFrom)}
          </p>
          <p className="text-xl font-bold text-gray-900 dark:text-white capitalize">
            To:{" "}
            {event.isMultiDay
              ? formatLocalDate(event.finalTimeTo)
              : formatLocalDateTime(event.finalTimeTo)}
          </p>
        </div>
      </div>
    </div>
