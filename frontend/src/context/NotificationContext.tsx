...
const Toast = ({ type, message, onClose }: Notification & { onClose: () => void }) => {
    const styles = {
        ...
        warning: "bg-yellow-50 text-yellow-800 border-yellow-200 dark:bg-yellow-900/80 dark:text-yellow-100 dark:border-yellow-800",
    ...
    return (
        <div className={`pointer-events-auto flex items-start gap-3 p-4 rounded-lg border shadow-lg transform transition-all animate-in slide-in-from-right-full duration-300 ${styles[type]}`}>
